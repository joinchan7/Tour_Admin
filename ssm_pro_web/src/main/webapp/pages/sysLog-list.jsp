    ...
    <div class="content-wrapper">
        ...
        <section class="content-header" style="margin-top: 50px">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/sysLogs">日志管理</a></li>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <thead>
                            <tr>
                                <th class="" style="padding-right: 0"><input id="selall"
                                                                             type="checkbox"
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <c:forEach begin="10" end="40" var="total" step="5">
                                    <option
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="sysLogs?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="sysLogs?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li>
                                    <a href="sysLogs?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="sysLogs?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="sysLogs?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
