            ...
            <div class="box box-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs deleteBtn"
                                                del_uri="user/${user.id}">删除用户
                                        </button>
                                        <a href="${pageContext.request.contextPath}/user/${user.id}/roles"
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="users?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="users?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            ...
                            <li>
                                <a href="users?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="users?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
...
<script type="text/javascript">
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变每页显示条数
        location.href = "users?page=${pageInfo.pageNum}&size=" + pageSize;
    }
