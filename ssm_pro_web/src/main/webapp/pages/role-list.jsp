            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a type="button" class="btn btn-default" title="新建" href="role">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/role/${role.id}"
                                           class="btn bg-olive btn-xs">详情
                                        </a>
                                        <button type="button" class="btn bg-olive btn-xs deleteBtn"
                                                del_uri="role/${role.id}">删除角色
                                        </button>
                                        <a href="${pageContext.request.contextPath}/role/${role.id}/permissions"
                                           class="btn bg-olive btn-xs">添加权限
                                        </a>
                                        <!--deleteBtn的表单-->
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="roles?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="roles?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                <li>
                                    <a href="roles?page=${pageNum}&size=${pageInfo.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="roles?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="roles?page=${pageInfo.pages}&size=${pageInfo.pageSize}"
...
<script type="text/javascript">
    ...
    function changePageSize() {
        ...
        //向服务器发送请求，改变每页显示条数
        location.href = "roles?page=${pageInfo.pageNum}&size=" + pageSize;
    }
