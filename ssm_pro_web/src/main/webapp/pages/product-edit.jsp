                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                    name="productStatus">
                                <option value="0"
                                        <c:if test="${'0' eq product.productStatus}">selected</c:if> >关闭
                                </option>
                                <option value="1"
                                        <c:if test="${'1' eq product.productStatus}">selected</c:if> >开启
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-10 data rowHeight2x">
                            <textarea style="resize:none" class="form-control" name="productDesc" cols=""
