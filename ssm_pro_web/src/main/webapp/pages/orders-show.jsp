            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-10 data rowHeight2x">
                        <textarea style="resize:none" class="form-control" rows="3" placeholder="其他信息"
                                  cols="" readonly>${orders.orderDesc}</textarea>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <table id="dataList"
                    ...
                    <c:forEach var="traveller" items="${orders.travellers}">
                        ...
                        <tr>
                            <td><input type="text" size="10" value="${traveller.travellerTypeStr}" readonly="readonly">
                            </td>
                            ...
                            <td><input type="text" size="15" value="${traveller.credentialsTypeStr}"
                                       readonly="readonly"></td>
                            <td><input type="text" size="28" value="${traveller.credentialsNum}" readonly="readonly">
                            </td>
                        </tr>
                    </c:forEach>
